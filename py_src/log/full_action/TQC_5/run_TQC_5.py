...
def main():
    ...
    total_timestep = 5e6
    MODEL_PATH="/home/kist-robot2/catkin_ws/src/franka_emika_panda/py_src/log/full_action/TQC_5/step_900103.zip"
    istrain =  False
    isrendering =True
    israndomenv = False
    isheuristic = False
    env = fr3Env.fr3_full_action()
    env.env_rand = israndomenv
    env.rendering = isrendering
    # env.reset()
    policy_kwargs = dict(n_critics=5, n_quantiles=25)

    model = TQCsm_new("MultiInputPolicy",
                  env,
                  top_quantiles_to_drop_per_net=2,
                  verbose=1,
                  policy_kwargs=policy_kwargs,
                  save_path='/home/kist-robot2/catkin_ws/src/franka_emika_panda/py_src/log/full_action/TQC_12/step_{}',
                  save_interval=1e5,
